...
export default class ChatGPTClient {
    ...
    setOptions(options) {
        ...
        this.isChatGptModel = this.modelOptions.model.startsWith('gpt-') || this.modelOptions.model.startsWith('moonshot-');
        ...
        console.log(`inspecting modelOptions=${JSON.stringify(this.modelOptions)}, maxResponseTokens=${this.maxResponseTokens}`);
